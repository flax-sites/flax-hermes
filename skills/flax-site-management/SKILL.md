...
let the user finish. When the site is published, the app returns the new site
URL and hands a continuation prompt back to the agent so it can continue
working on the new site; use that URL for subsequent management.
